...
//            // caching is like probably bugging this, so its setting it to go to 0
//            auto.intializationLoop(frontOrBackAuto); // hardcode this as false this variable might be the problem
//            telemetry.addData("start Pose", auto.autoTrajectories.startPoseBack.toString());
...
//            telemetry.addData("frontOrBackAuto", frontOrBackAuto);
//            telemetry.update();
//        }
//
//
